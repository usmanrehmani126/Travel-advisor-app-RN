  ...
  return (
    <SafeAreaView className="flex-1 bg-white relative">
      ...
      <ScrollView className="flex-1 px-4 py-6">
        <View className="relative bg-white shadow-lg mt-4">
          <Image
            source={{
          ...
          <View className="absolute flex-row inset-x-0 bottom-5 justify-between px-6">
            ...
            <View className="px-1 items-center justify-center rounded-md bg-teal-100">
        ...
        <View className="mt-6">
          ...
          <View className="flex-row items-center space-x-2 mt-2">
            ...
            <Text className="text-[#8C9EA6] text-[17px] font-bold">
        ...
        <View className="mt-4 flex-row items-center justify-between">
          ...
          {data?.price_level && (
            <View className=" flex-row items-center space-x-2">
              ...
              <View>
                <Text className="text-[#515151]">{data?.price_level ? data?.price_level:"34"}</Text>
        ...
        <View className=" space-y-2 mt-4 bg-gray-100 rounded-2xl px-4 py-2">
          ...
          <TouchableOpacity className="mt-4 px-4 py-3 rounded-lg bg-[#06B2BE] items-center justify-center mb-12" onPress={()=>Linking.openURL(data.web_url)}>
